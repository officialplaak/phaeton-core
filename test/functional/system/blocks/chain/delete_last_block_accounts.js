	...
	describe('deleteLastBlock', () => {
		...
		describe('single transaction scenarios: create transaction, forge, delete block, forge again', () => {
			...
			function createAccountWithFunds(done) {
				...
				var sendTransaction = phaeton.transaction.transfer({
			...
			describe('(type 0) transfer funds', () => {
				...
				it('should create a transaction and forge a block', done => {
					...
					var transferTransaction = phaeton.transaction.transfer({
						amount: 100000000,
			...
			describe('(type 1) register second signature', () => {
				...
				it('should forge a block', done => {
					var signatureTransaction = phaeton.transaction.registerSecondPassphrase({
						passphrase: testAccount.passphrase,
			...
			describe('(type 2) register delegate', () => {
				...
				it('should forge a block', done => {
					var delegateTransaction = phaeton.transaction.registerDelegate({
						passphrase: testAccount.passphrase,
			...
			describe('(type 3) votes', () => {
				...
				it('should forge a block', done => {
					var voteTransaction = phaeton.transaction.castVotes({
						passphrase: testAccount.passphrase,
			...
			describe('(type 4) register multisignature', () => {
				...
				it('should forge a block', done => {
					var multisigTransaction = phaeton.transaction.registerMultisignature({
						passphrase: testAccount.passphrase,
						keysgroup: [accountFixtures.existingDelegate.publicKey],
						lifetime: 1,
						minimum: 1,
					});
					var signature = phaeton.transaction.utils.multiSignTransaction(
						multisigTransaction,
			...
			describe('dapps', () => {
				...
				describe.skip('(type 6) inTransfer dapp', () => {
					...
					it('should forge a block', done => {
						var inTransferTransaction = phaeton.transaction.transferIntoDapp({
							passphrase: testAccount.passphrase,
							amount: 10 * 100000000,
				...
				describe.skip('(type 7) outTransfer dapp', () => {
					...
					it('should forge a block', done => {
						var outTransferTransaction = phaeton.transaction.transferOutOfDapp({
							passphrase: testAccount.passphrase,
							amount: 10 * 100000000,
							dappId: randomUtil.guestbookDapp.id,
