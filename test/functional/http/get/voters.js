	...
	describe('?', () => {
		...
		describe('sort', () => {
			...
			before(() => {
				...
				var enrichExtraDelegateVoterTransaction = phaeton.transaction.transfer({
					amount,
					passphrase: accountFixtures.genesis.passphrase,
					recipientId: validExtraDelegateVoter.address,
				});

				var registerExtraVoterAsADelegateTransaction = phaeton.transaction.registerDelegate(
					{
				...
				var voteByExtraDelegateVoterTransaction = phaeton.transaction.castVotes({
					passphrase: validExtraDelegateVoter.passphrase,
