...
__private.verifyPayload = function(block, result) {
	...
	//console.log(block.payloadHash);
	// console.log(blakejs.blake2b(Buffer.from(blake_bytes), null, 32));
	// TODO :: REMOVED if (blakejs.blake2b(Buffer.from(blake_bytes), null, 32) !== block.payloadHash) {
