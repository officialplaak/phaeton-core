/*
 * PhaetonHQ/phaeton-scripts/updateConfig.js
 * Copyright (C) 2017 Phaeton Foundation
 *
 ...
 *
 * Usage Example:
 * 		node scripts/update_config.js ../phaeton-backup/config.json ./config/mainnet/config.json
 *
 * 	Reference:
 * 		A user manual can be found on documentation site under /documentation/phaeton-core/upgrade/upgrade-configurations
 */
...
if (oldConfig.version === '1.0.0-rc.1') {
	...
	// https://github.com/PhaetonHQ/phaeton/issues/2154
	oldConfig.api.ssl = extend(true, {}, oldConfig.ssl);
	delete oldConfig.ssl;

	// https://github.com/PhaetonHQ/phaeton/issues/2208
